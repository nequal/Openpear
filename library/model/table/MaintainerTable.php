...
class MaintainerTable extends TableObjectBase{
	...
	function columnName(){
		if(!Rhaco::isVariable("_R_D_C_","Maintainer::Name")){
			$column = new Column("column=name,variable=name,type=string,require=true,unique=true,chartype=/^[A-Za-z0-9_\-]+$/,",__CLASS__);
	...
	function columnFullname(){
		if(!Rhaco::isVariable("_R_D_C_","Maintainer::Fullname")){
			$column = new Column("column=fullname,variable=fullname,type=string,",__CLASS__);
